...
const CORE = ['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./learning-core.js?v=59.1','./adventure.js?v=59.1','./adventure.css?v=59.1','./visuals.js?v=59.1','./visuals.css?v=59.1','./assets/meadow.svg'];
